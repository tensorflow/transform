...
"ApplySavedModel[0]" [label="{ApplySavedModel|phase: 0|label: ApplySavedModel[0]}"];
"CreateSavedModelForAnalyzerInputs[0]" -> "ApplySavedModel[0]";
"TensorSource[x/mean_and_var]" [label="{ExtractFromDict|keys: ('x/mean_and_var/Cast', 'x/mean_and_var/truediv', 'x/mean_and_var/truediv_1')|label: TensorSource[x/mean_and_var]}"];
"ApplySavedModel[0]" -> "TensorSource[x/mean_and_var]";
"Combine[x/mean_and_var]" [label="{Combine|combiner: \<MeanAndVarCombiner\>|label: Combine[x/mean_and_var]|{<0>0|<1>1}}"];
"TensorSource[x/mean_and_var]" -> "Combine[x/mean_and_var]";
...
"Combine[x/mean_and_var]":0 -> "CreateTensorBinding[x/mean_and_var/Placeholder]";
...
"Combine[x/mean_and_var]":1 -> "CreateTensorBinding[x/mean_and_var/Placeholder_1]";
...
"ApplySavedModel[0]" [label="{ApplySavedModel|phase: 0|label: ApplySavedModel[0]}"];
"CreateSavedModelForAnalyzerInputs[0]" -> "ApplySavedModel[0]";
"TensorSource[x]" [label="{ExtractFromDict|keys: ('x/Reshape',)|label: TensorSource[x]}"];
...
"ApplySavedModel[1]" [label="{ApplySavedModel|phase: 1|label: ApplySavedModel[1]}"];
"CreateSavedModelForAnalyzerInputs[1]" -> "ApplySavedModel[1]";
"TensorSource[x_square_deviations/mean_and_var]" [label="{ExtractFromDict|keys: ('x_square_deviations/mean_and_var/Cast', 'x_square_deviations/mean_and_var/truediv', 'x_square_deviations/mean_and_var/truediv_1')|label: TensorSource[x_square_deviations/mean_and_var]}"];
"ApplySavedModel[1]" -> "TensorSource[x_square_deviations/mean_and_var]";
"Combine[x_square_deviations/mean_and_var]" [label="{Combine|combiner: \<MeanAndVarCombiner\>|label: Combine[x_square_deviations/mean_and_var]|{<0>0|<1>1}}"];
"TensorSource[x_square_deviations/mean_and_var]" -> "Combine[x_square_deviations/mean_and_var]";
...
"Combine[x_square_deviations/mean_and_var]":0 -> "CreateTensorBinding[x_square_deviations/mean_and_var/Placeholder]";
...
"Combine[x_square_deviations/mean_and_var]":1 -> "CreateTensorBinding[x_square_deviations/mean_and_var/Placeholder_1]";
...
"ApplySavedModel[0]" [label="{ApplySavedModel|phase: 0|label: ApplySavedModel[0]}"];
"CreateSavedModelForAnalyzerInputs[0]" -> "ApplySavedModel[0]";
"TensorSource[x]" [label="{ExtractFromDict|keys: ('inputs/x',)|label: TensorSource[x]}"];
"ApplySavedModel[0]" -> "TensorSource[x]";
