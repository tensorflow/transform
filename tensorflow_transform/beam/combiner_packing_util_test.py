...
"ExtractCombineMergeOutputs[y/mean_and_var]" [label="{ExtractCombineMergeOutputs|output_tensor_info_list: [TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False), TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False)]|label: ExtractCombineMergeOutputs[y/mean_and_var]|{<0>0|<1>1}}"];
...
"VocabularyPrune[z]" [label="{VocabularyPrune|top_k: None|frequency_threshold: 0|informativeness_threshold: -inf|coverage_top_k: None|coverage_frequency_threshold: 0|coverage_informativeness_threshold: -inf|key_fn: None|label: VocabularyPrune[z]}"];
"VocabularyMerge[z]" -> "VocabularyPrune[z]";
"VocabularyOrderAndWrite[z]" [label="{VocabularyOrderAndWrite|vocab_filename: vocab_z|store_frequency: False|input_dtype: string|label: VocabularyOrderAndWrite[z]|fingerprint_shuffle: False}"];
...
"ExtractPackedCombineMergeOutputs[CacheableCombineMerge[y/mean_and_var]]" [label="{ExtractPackedCombineMergeOutputs|output_tensor_info_list: [TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False), TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False)]|label: ExtractPackedCombineMergeOutputs[CacheableCombineMerge[y/mean_and_var]]|{<0>0|<1>1}}"];
...
"ExtractPackedCombineMergeOutputs[CacheableCombineMerge[x/mean_and_var]]" [label="{ExtractPackedCombineMergeOutputs|output_tensor_info_list: [TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False), TensorInfo(dtype=tf.float32, shape=(), is_asset_filepath=False)]|label: ExtractPackedCombineMergeOutputs[CacheableCombineMerge[x/mean_and_var]]|{<0>0|<1>1}}"];
