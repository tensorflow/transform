...
_ENCODE_DECODE_CASES = [
    ...
    dict(testcase_name='multiple_columns_unicode',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
    ...
    dict(testcase_name='multiple_columns_tab_separated',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line=(
         ...
         delimiter='\t'),
    dict(testcase_name='multiple_columns_multivalent',
         columns=[
    ...
    dict(testcase_name='2x2_matrix_int_multivalent',
         columns=['x'],
...
_DECODE_ONLY_CASES = [
    dict(testcase_name='scalar_float_with_decimal_point',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.float32)},
         csv_line='12.0',
         instance={'x': 12}),
    dict(testcase_name='scalar_float_with_quoted_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.float32)},
         csv_line='"12.0"',
         instance={'x': 12}),
    dict(testcase_name='var_len_string_with_missing_value',
         columns=['x'],
         feature_spec={'x': tf.VarLenFeature(tf.string)},
         csv_line='',
         instance={'x': []}),
    dict(testcase_name='multiple_columns_numpy',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line='12,"this is a ,text",categorical_value,1,89.0,12.0,20',
         instance={
    ...
    dict(testcase_name='multiple_columns_unicode_numpy',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line=u'12,"this is a ,text",Hello κόσμε,1,89.0,12.0,20',
         instance={
    ...
    dict(testcase_name='multiple_missing_var_len_features',
         columns=['a', 'b', 'c'],
         feature_spec={
...
_CONSTRUCTOR_ERROR_CASES = [
    dict(testcase_name='size_1_vector_with_missing_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([2], tf.int64)},
         error_msg=r'FixedLenFeature \"x\" was not multivalent'),
    dict(testcase_name='missing_column',
         columns=[],
         feature_spec={'x': tf.FixedLenFeature([], tf.int64)},
...
_DECODE_ERROR_CASES = [
    dict(testcase_name='scalar_with_missing_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.int64)},
         csv_line='',
    ...
    dict(testcase_name='size_1_vector_with_missing_value',
         ...
         csv_line='',
         error_msg=r'expected a value on column \"x\"'),
    dict(testcase_name='scalar_string_missing_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.string)},
         csv_line='',
         error_msg=r'expected a value on column \"x\"'),
    dict(testcase_name='sparse_feature_with_missing_value_but_present_index',
         columns=['idx', 'value'],
         feature_spec={'x': tf.SparseFeature('idx', 'value', tf.float32, 10)},
         csv_line='5,',
         error_msg=(r'SparseFeature \"x\" has indices and values of different '
                    r'lengths')),
    dict(testcase_name='sparse_feature_with_missing_index_but_present_value',
         columns=['idx', 'value'],
         feature_spec={'x': tf.SparseFeature('idx', 'value', tf.float32, 10)},
         csv_line=',2.0',
         error_msg=(r'SparseFeature \"x\" has indices and values of different '
                    r'lengths')),
    dict(testcase_name='sparse_feature_with_negative_index',
         columns=['idx', 'value'],
         feature_spec={'x': tf.SparseFeature('idx', 'value', tf.float32, 10)},
         csv_line='-1,2.0',
         error_msg=r'has index -1 out of range'),
    dict(testcase_name='sparse_feature_with_index_equal_to_size',
         columns=['idx', 'value'],
         feature_spec={'x': tf.SparseFeature('idx', 'value', tf.float32, 10)},
         csv_line='10,2.0',
         error_msg=r'has index 10 out of range'),
    dict(testcase_name='sparse_feature_with_index_greater_than_size',
         columns=['idx', 'value'],
         feature_spec={'x': tf.SparseFeature('idx', 'value', tf.float32, 10)},
         csv_line='11,2.0',
         error_msg=r'has index 11 out of range'),
    dict(testcase_name='scalar_float_with_non_float_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.float32)},
         csv_line='test',
         error_msg=r'could not convert string to float: test'),
    dict(testcase_name='multivalent_scalar_float_too_many_values',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([], tf.float32)},
         csv_line='1|2',
         ...
         secondary_delimiter='|',
         multivalent_columns=['x']),
    dict(testcase_name='multivalent_size_1_vector_float_too_many_values',
         columns=['x'],
         ...
         secondary_delimiter='|',
         multivalent_columns=['x']),
    dict(testcase_name='multivalent_size_2_vector_float_too_many_values',
         columns=['x'],
         ...
         secondary_delimiter='|',
         multivalent_columns=['x']),
    dict(testcase_name='row_has_more_columns_than_expected',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
    ...
    dict(testcase_name='row_has_fewer_columns_than_expected',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line='12,"this is a ,text",categorical_value"',
         error_msg='Columns do not match specified csv headers',
         error_type=csv_coder.DecodeError),
    dict(testcase_name='row_is_empty',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line='',
         error_msg='Columns do not match specified csv headers',
         error_type=csv_coder.DecodeError),
    dict(testcase_name='csv_line_not_a_string',
         columns=_COLUMNS,
         feature_spec=_FEATURE_SPEC,
         csv_line=123,
         error_msg='\'int\' object has no attribute \'encode\': 123',
         error_type=csv_coder.DecodeError),
]

_ENCODE_ERROR_CASES = [
    dict(testcase_name='multivalent_size_2_vector_3_values',
         columns=['x'],
         ...
         secondary_delimiter='|',
         multivalent_columns=['x']),
    dict(testcase_name='multivalent_size_2_vector_1_value',
         columns=['x'],
         feature_spec={'x': tf.FixedLenFeature([2], tf.string)},
         instance={'x': [1]},
         error_msg=r'FixedLenFeature \"x\" got wrong number of values',
...
class TestCSVCoder(test_case.TransformTestCase):
  ...
  def test_constructor_error(self, columns, feature_spec, error_msg,
  ...
  def test_decode_error(self, columns, feature_spec, csv_line, error_msg,
                        error_type=ValueError, **kwargs):
    schema = dataset_schema.from_feature_spec(feature_spec)
    coder = csv_coder.CsvCoder(columns, schema, **kwargs)
    with self.assertRaisesRegexp(error_type, error_msg):
  ...
  def test_encode_error(self, columns, feature_spec, instance, error_msg,
                        error_type=ValueError, **kwargs):
    schema = dataset_schema.from_feature_spec(feature_spec)
    coder = csv_coder.CsvCoder(columns, schema, **kwargs)
    with self.assertRaisesRegexp(error_type, error_msg):
