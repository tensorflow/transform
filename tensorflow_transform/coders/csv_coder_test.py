...
_FEATURE_SPEC = {
    ...
    "2dsparse": tf.io.SparseFeature(
        ["2d_idx0", "2d_idx1"], "2d_val", tf.float32, [2, 10]
    ),
}
...
_ENCODE_CASES = [
    ...
    dict(
        ...
        columns=_COLUMNS,
        feature_spec=_FEATURE_SPEC,
        csv_line='12,"this is a ,text",Hello κόσμε,1,89.0,12.0,20,1,7,17.0',
        instance={
            "category1": ["Hello κόσμε".encode()],
            "numeric1": 12,
            "numeric2": [89.0],
            "numeric3": [20],
            "text1": b"this is a ,text",
    ...
    dict(
        ...
        columns=["numeric1", "category1", "idx", "numeric2", "value", "numeric3"],
        feature_spec={
        ...
        csv_line=("11|12,categorical_value|other_value,1|3,89.0|91.0," "12.0|15.0,20"),
        instance={
...
class TestCSVCoder(test_case.TransformTestCase):
    ...
    def test_constructor_error(
        self, columns, feature_spec, error_msg, error_type=ValueError, **kwargs
    ):
        schema = schema_utils.schema_from_feature_spec(feature_spec)
