...
class SchemaUtilsTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(*schema_utils_test_cases.INVALID_SCHEMA_PROTOS)
    ...
    @parameterized.named_parameters(*schema_utils_test_cases.INVALID_FEATURE_SPECS)
    ...
    def test_pop_ragged_source_columns(
        self,
        name,
